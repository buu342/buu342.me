...
Spriter's Resource also has an offshoot site called [The Sounds Resource](https://sounds-resource.com). Convenient. Luckly the sounds can just be zipped up and submitted, as I have done so [here](https://www.sounds-resource.com/mobile/musicworld/).
