...
class FrameImageInsert : public wxFrame
{
    private:
    ...
    public:
        FrameImageInsert(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Insert Image"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(400, 300), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL);
        ~FrameImageInsert();
